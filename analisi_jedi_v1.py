...
if __name__ == "__main__":
    ...
    nx.draw(G_anh,
            ...
            font_size=8,
            edge_color='gray')
    plt.title("Rete dei Personaggi di 'Star Wars: Return of the Jedi'", size=20)
    plt.savefig('star_wars_jedi_network.png')
    print("\nIl grafico della rete è stato salvato come 'star_wars_jedi_network.png'")
    ...
    plt.savefig('star_wars_jedi_network_communities.png')
    print("\nIl grafico della rete con le community è stato salvato come 'star_wars_jedi_network_communities.png'")
    ...
    plt.grid(True)
    plt.legend()
    plt.savefig('star_wars_jedi_robustness_analysis.png')
    print("\nIl grafico dell'analisi di robustezza è stato salvato come 'star_wars_jedi_robustness_analysis.png'")
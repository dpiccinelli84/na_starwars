...
if __name__ == "__main__":
    ...
    file_path = 'movie-jsons/empire.json'

    # Costruisci la rete per "Empire Strikes Back"
    G_anh = build_network_from_json(file_path)

    # Stampa alcune informazioni base
    print("Rete di 'Star Wars: Empire Strikes Back' costruita con successo!")
    ...
    nx.draw(G_anh,
            ...
            font_size=8,
            edge_color='gray')
    plt.title("Rete dei Personaggi di 'Star Wars: Empire Strikes Back'", size=20)
    plt.savefig('star_wars_empire_network.png')
    print("\nIl grafico della rete è stato salvato come 'star_wars_empire_network.png'")
    ...
    plt.savefig('star_wars_empire_network_communities.png')
    print("\nIl grafico della rete con le community è stato salvato come 'star_wars_empire_network_communities.png'")
    ...
    plt.grid(True)
    plt.legend()
    plt.savefig('star_wars_empire_robustness_analysis.png')
    print("\nIl grafico dell'analisi di robustezza è stato salvato come 'star_wars_empire_robustness_analysis.png'")